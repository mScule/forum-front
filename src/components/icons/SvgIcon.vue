...
<template>
  <svg :class="size" :style="`fill: var(${color});`" viewBox="0 0 16 16">
    ...
    <template v-else-if="name === 'information'">
      <path d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/>
    ...
    <template v-else-if="name === 'vote-up'">
      <template v-if="active">
    ...
    <template v-else-if="name === 'vote-down'">
      <template v-if="active">
    ...
    <template v-else-if="name === 'no-connection'">
    ...
    <template v-else-if="name === 'private'">
      <template v-if="active">
